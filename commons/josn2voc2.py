...
# 1.标签路径
labelme_path = f'D:\Liux\梨\\'
# 原始labelme标注数据路径
saved_path = f'D:\Liux\VOC\\'
# 保存路径
...
for json_file_ in files:
    ...
    height, width, channels = cv2.imread(f'D:\Liux\pear/' + json_file_ + ".jpg").shape
...
image_files = glob(f'D:\Liux\pear/' + "*.JPG")
...
total_files = glob(f"D:\实验\\2024金桔\金桔缺陷分类数据集\\voc2\Annotations/*.xml")
